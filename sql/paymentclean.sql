...
(
    pcacassistanceinfo_id                   int(64) not null comment 'id序号',
...
(
    pcacriskinfo_id                   int(64) not null comment 'id序号',
    up_date              varchar(10) comment '推送日期',
