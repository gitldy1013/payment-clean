...
@ApiModel(value="PcacMerchantRiskInfo对象", description="")
public class PcacMerchantRiskInfo extends Model<PcacMerchantRiskInfo> {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "序号id")
    @TableId(value = "pcac_merchant_risk_info_id", type = IdType.AUTO)
    private Integer pcacMerchantRiskInfoId;
    ...
    @ApiModelProperty(value = "获取方式:1 推送 2 查询")
    private String recType;


    @Override
    protected Serializable pkVal() {
        return this.pcacMerchantRiskInfoId;
    }
