...
public class ResultBean<T> implements Serializable {
  ...
  @Builder.Default private String resMsg = "success";
  @Builder.Default private String resCode = ResultBean.SUCCESS_CODE;
  ...
  /** @Description : 此时系统发生未知异常 @Param : [e] @Return : @Date : 2019-10-11 */
