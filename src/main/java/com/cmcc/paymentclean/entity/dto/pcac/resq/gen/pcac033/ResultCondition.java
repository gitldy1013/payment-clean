...
@XmlType(
    name = "",
    propOrder = {"resultQueryInfo", "resultInfo"})
...
public class ResultCondition {
   ...
   *
   * @return possible object is {@link ResultQueryInfo }
   */
   ...
   *
   * @param value allowed object is {@link ResultQueryInfo }
   */
   ...
   * there is not a <CODE>set</CODE> method for the resultInfo property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ResultInfo }
   */
