...
public class QueryPcacMerchantRiskInfoResp implements Serializable {
    ...
    @ExcelExportField(name = "反馈状态", index = 57)
    @ApiModelProperty(value = "反馈状态")
    private String feedbackStatus;

    @ExcelExportField(name = "反馈日期", index = 58)
    @ApiModelProperty(value = "反馈日期")
    private Date feedbackDate;

    @ExcelExportField(name = "操作人", index = 59)
    @ApiModelProperty(value = "操作人")
    private String operator;

    @ExcelExportField(name = "失败原因", index = 60)
