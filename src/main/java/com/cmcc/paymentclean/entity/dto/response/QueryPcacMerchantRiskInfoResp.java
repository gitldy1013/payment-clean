...
public class QueryPcacMerchantRiskInfoResp implements Serializable {
  ...
  @ExcelExportField(name = "商户编号", index = 7)
  @ApiModelProperty(value = "商户编号")
  private String mercIds;

  @ExcelExportField(name = "商户个数", index = 8)
  @ApiModelProperty(value = "商户个数")
  private String cusCodeCount;

  @ExcelExportField(name = "涉及结算金额", index = 9)
  @ApiModelProperty(value = "涉及结算金额(后台计算)")
  private String submitAmount;

  @ExcelExportField(name = "法人证件类型", index = 10)
  @ApiModelProperty(value = "法人证件类型")
  private String docType;

  @ExcelExportField(name = "法人证件号码", index = 11)
  @ApiModelProperty(value = "法人证件号码")
  private String docCode;

  @ExcelExportField(name = "法定代表人姓名", index = 12)
  @ApiModelProperty(value = "法定代表人姓名")
  private String legRepName;

  @ExcelExportField(name = "法定代表人（负责人） 证件类型", index = 13)
  @ApiModelProperty(value = "法定代表人（负责人） 证件类型")
  private String legDocType;

  @ExcelExportField(name = "法定代表人（负责人）证件号码", index = 14)
  @ApiModelProperty(value = "法定代表人（负责人）证件号码")
  private String legDocCode;

  @ExcelExportField(name = "返回数量", index = 15)
  @ApiModelProperty(value = "返回数量")
  private String count;

  @ExcelExportField(name = "中转或收款", index = 16)
  @ApiModelProperty(value = "中转或收款 0 收款 1 中转")
  private String isTransfer;

  @ExcelExportField(name = "银行结算账号", index = 17)
  @ApiModelProperty(value = "银行结算账号")
  private String bankNo;

  @ExcelExportField(name = "开户行", index = 18)
  @ApiModelProperty(value = "开户行（支付账户开立机构）")
  private String openBank;

  @ExcelExportField(name = "网址", index = 19)
  @ApiModelProperty(value = "网址")
  private String url;

  @ExcelExportField(name = "服务器 IP", index = 20)
  @ApiModelProperty(value = "服务器 IP")
  private String serverIp;

  @ExcelExportField(name = "法定代表人（负责人） 手机号", index = 21)
  @ApiModelProperty(value = "法定代表人（负责人） 手机号")
  private String mobileNo;

  @ExcelExportField(name = "商户实际办公地", index = 22)
  @ApiModelProperty(value = "商户实际办公地")
  private String address;

  @ExcelExportField(name = "ICP 备案编号", index = 23)
  @ApiModelProperty(value = "ICP 备案编号")
  private String icp;

  @ExcelExportField(name = "风险信息等级", index = 24)
  @ApiModelProperty(value = "风险信息等级")
  private String level;

  @ExcelExportField(name = "风险事件发生时间", index = 25)
  @ApiModelProperty(value = "风险事件发生时间")
  private Date occurtimeb;

  @ExcelExportField(name = "风险事件结束时间", index = 26)
  @ApiModelProperty(value = "风险事件结束时间")
  private Date occurtimee;

  @ExcelExportField(name = "风险事件发生渠道", index = 27)
  @ApiModelProperty(value = "风险事件发生渠道")
  private String occurchan;

  @ExcelExportField(name = "风险事件发生地域", index = 28)
  @ApiModelProperty(value = "风险事件发生地域")
  private String occurarea;

  @ExcelExportField(name = "风险事件描述", index = 29)
  @ApiModelProperty(value = "风险事件描述")
  private String note;

  @ExcelExportField(name = "有效性", index = 30)
  @ApiModelProperty(value = "有效性")
  private String validStatus;

  @ExcelExportField(name = "有效期", index = 31)
  @ApiModelProperty(value = "有效期")
  private Date validDate;

  @ExcelExportField(name = "终止合作的机构数量", index = 32)
  @ApiModelProperty(value = "终止合作的机构数量")
  private String stopNum;

  @ExcelExportField(name = "涉及机构数", index = 33)
