 ...
 * generated in the com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac025 package. 
...
public class ObjectFactory {
    ...
    private final static QName _LegDocName_QNAME = new QName("", "LegDocName");
    ...
    private final static QName _UnitProp_QNAME = new QName("", "UnitProp");
    ...
    private final static QName _ShareHolder_QNAME = new QName("", "ShareHolder");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac025
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "LegDocName")
    public JAXBElement<String> createLegDocName(String value) {
        return new JAXBElement<String>(_LegDocName_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "UnitProp")
    public JAXBElement<String> createUnitProp(String value) {
        return new JAXBElement<String>(_UnitProp_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "ShareHolder")
    public JAXBElement<String> createShareHolder(String value) {
        return new JAXBElement<String>(_ShareHolder_QNAME, String.class, null, value);
    }
