...
@XmlType(
    name = "",
    propOrder = {"count", "upDate", "entInfo"})
...
public class PcacList {
   ...
   * there is not a <CODE>set</CODE> method for the entInfo property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link EntInfo }
   */
