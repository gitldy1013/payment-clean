 ...
 * generated in the com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac005 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Infos_QNAME = new QName("", "Infos");
    private final static QName _RecSystemId_QNAME = new QName("", "RecSystemId");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac005
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "Infos")
    public JAXBElement<String> createInfos(String value) {
        return new JAXBElement<String>(_Infos_QNAME, String.class, null, value);
    }
