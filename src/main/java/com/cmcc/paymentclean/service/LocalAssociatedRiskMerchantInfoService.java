...
public interface LocalAssociatedRiskMerchantInfoService {
   ...
   */
  ResultBean<Page<AssociatedRiskMerchantInfoResp>> pageLocalAssociatedRiskMerchantInfo(
   ...
   * @return 反馈状态信息
   */
  ResultBean<Body> localAssociatedRiskMerchantInfoBack(
      List<AssociatedRiskMerchantInfoBackReq> associatedRiskMerchantInfoBackReq);
}
