...
@Slf4j
@Service
public class PcacRiskInfoServiceImpl extends ServiceImpl<PcacRiskInfoMapper, PcacRiskInfo>
    implements PcacRiskInfoService {
  ...
  public ResultBean<Page<PcacRiskInfoResp>> pagePcacRiskInfo(PcacRiskInfoReq riskInfoReq) {
    log.info("pagePcacRiskInfo req={}", riskInfoReq);
    ...
    Page<PcacRiskInfoResp> pcacPersonRiskSubmitInfoPage =
        pcacRiskInfoMapper.pagePcacRiskInfo(page, riskInfoReq);
    ...
    if (!CollectionUtils.isEmpty(riskPersonResps)) {
      for (PcacRiskInfoResp riskPersonResp : riskPersonResps) {
        ...
        riskPersonResp.setLegDocType(
            LegDocTypeEnum.getLegDocTypeDesc(riskPersonResp.getLegDocType()));
        ...
        riskPersonResp.setPushListType(
            PushListTypeEnum.getPushListTypeDesc(riskPersonResp.getPushListType()));
        riskPersonResp.setOccurarea(SysLanEnum.getSysLanEnumDesc(riskPersonResp.getOccurarea()));
      }
    }
    ...
    log.info(
        "pagePcacRiskInfo resp={}", pcacPersonRiskSubmitInfoPage);
    return resultBean;
  }
  ...
  public ResultBean<com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac029.Body> reissueRiskInfo(
      ReissueRiskInfoReq reissueRiskInfoReq) {
    ResultBean<com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac029.Body> resultBean = null;
    byte[] symmetricKeyEncoded = CFCACipherUtils.getSymmetricKeyEncoded();
    com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcaclogin.Document<
            com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac029.Body>
        document = new com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcaclogin.Document<>();
    com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcaclogin.Request<
            com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac029.Body>
        request =
            XmlJsonUtils.getRequest(
                ...
                document,
                pcacConfig,
                TrnxCodeEnum.RISK_INFO_REISSUE.getCode());
    com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac029.Body body =
        new com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac029.Body();
            ...
            new Runnable() {
              ...
              public void run() {
                ...
                for (RiskInfo riskInfo : pcacList.getRiskInfo()) {
                  ...
                  // 法定代表人姓名
                  String decryptLegDocName =
                      CFCACipherUtils.decrypt(secretKey, riskInfo.getLegDocName());
