...
@Slf4j
@Service
public class RiskMerchantRiskSyncInfoServiceImpl
    extends ServiceImpl<RiskMerchantRiskSyncInfoMapper, RiskMerchantRiskSyncInfo>
    implements RiskMerchantRiskSyncInfoService {
  ...
  public ResultBean<Boolean> addMerchant(List<RiskMerchantRiskSyncInfoReq> riskMerchantList) {
    ...
    for (RiskMerchantRiskSyncInfoReq riskMerchant : riskMerchantList) {
      ...
      riskMerchantRiskSyncInfo.setSourceChannel(
          this.splitStrs(riskMerchantRiskSyncInfo.getSourceChannel()));
      ...
      riskMerchantRiskSyncInfo.setCusNature(
          this.splitStrs(riskMerchantRiskSyncInfo.getCusNature()));
      ...
      if (null != riskMerchant1) {
        ...
        updateWrapper.eq(
            "risk_merchant_risk_sync_info_id", riskMerchant1.getRiskMerchantRiskSyncInfoId());
