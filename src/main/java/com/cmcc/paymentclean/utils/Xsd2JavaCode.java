...
public class Xsd2JavaCode {
  ...
  public static void main(String[] args) {
    ...
    try {
      String XSD_CODES = CodeGenerator.scanner("请输入对应的报文编号,多个用英文逗号分隔：");
      String[] strs = XSD_CODES.split(",");
      for (String XSD_CODE : strs) {
        // xjc -encoding UTF-8 -p com.cmcc.paymentclean.entity.dto.pcac.resq.gen.pcac059
        // C:\Users\liudongyang\IdeaProjects\payment-clean\src\main\resources\xsds\pcac.ries.013.xsd
        // -d C:\Users\liudongyang\IdeaProjects\payment-clean\src\main\java\
        String execStr =
            "xjc -encoding UTF-8 -p "
                + BASE_PACKAGE
                + XSD_CODE.replace("-", "_")
                + " "
                + XSD_DIR
