...
public class XmlJsonUtils {
  ...
  public static <T> Request<T> getRequest(
    ...
    head.setTrnxTime(
        DateUtils.formatTime(new Date(System.currentTimeMillis()), DateUtils.FORMAT_TIME_PCAC));
  ...
  public static com.cmcc.paymentclean.entity.dto.pcac.resp.Document getRespDocument(
    ...
    respInfo.setResultCode(PcacResultCodeEnum.S00000.getCode());
  ...
  /** 组装响应报文头的信息 */
  public static com.cmcc.paymentclean.entity.dto.pcac.resp.Head getRespHead(
      String trnxCode, PcacConfig pcacConfig, String identification) {
    Date date = new Date();
    com.cmcc.paymentclean.entity.dto.pcac.resp.Head head =
        new com.cmcc.paymentclean.entity.dto.pcac.resp.Head();
    head.setVersion(pcacConfig.getVersion());
    // 报文唯一标识（8 位日期+10 顺序号）
