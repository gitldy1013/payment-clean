...
@Mapper
@Repository
public interface LocalAssociatedRiskMerchantInfoMapper
    extends BaseMapper<LocalAssociatedRiskMerchantInfo> {

  Page<AssociatedRiskMerchantInfoResp> pageLocalAssociatedRiskMerchantInfo(
      Page page, @Param("req") AssociatedRiskMerchantInfoReq req);
}
